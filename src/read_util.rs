...
use std::borrow::Cow;
use std::io::{stdin, stdout, BufReader, BufWriter, Read, Seek, SeekFrom, Write};
use std::sync::Arc;
use std::{cmp};
use log::error;
use memmap2::Mmap;
...
pub fn read_input(mode: Mode, input: Input, keyword: &str) {
        ...
        Input::File(_) => {
            ...
            match mode {
                ...
                Mode::Chunk => {
                    ...
                    if ENVIRONMENT.get().unwrap().unstable {
